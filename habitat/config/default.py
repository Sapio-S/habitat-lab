...
ACTIONS.VELOCITY_CONTROL.LIN_VEL_RANGE = [0., 0.25] # meters per sec
ACTIONS.VELOCITY_CONTROL.ANG_VEL_RANGE = [-10., 10.] # deg per sec
ACTIONS.VELOCITY_CONTROL.MIN_ABS_LIN_SPEED = 0.025 # meters per sec
ACTIONS.VELOCITY_CONTROL.MIN_ABS_ANG_SPEED = 1. # deg per sec
